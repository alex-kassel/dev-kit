...
|---|---|:---:|---|---|
| **Audit Verification** | Emerald Green | `#10b981` | `[![Audit Verified](https://img.shields.io/badge/Audit-Verified-10b981?logo=shield)](RELEASE-GATE.md)` | `RELEASE-GATE.md` |
...
| **Static Analysis** | Purple | `#8b5cf6` | `[![PHPStan](https://img.shields.io/badge/PHPStan-Level%208-8b5cf6?logo=php&logoColor=white)](phpstan.neon)` | `phpstan.neon` |

> [!IMPORTANT]
> - **Audit Badge Rule**: If `RELEASE-GATE.md` exists, `Audit Verified` MUST be the very first badge. If `RELEASE-GATE.md` does not exist, omit this badge completely.
