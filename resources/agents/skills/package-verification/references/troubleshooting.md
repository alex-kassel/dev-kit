...
1. **Standalone Utility Packages (e.g. `history-engine`):**
...
- **Cause**: Missing or incorrect `tests/bootstrap.php`.
...
- Execute `composer pkg:check <vendor>/<package> --fix` to auto-format code.
